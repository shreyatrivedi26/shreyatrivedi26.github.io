...
II. **Assessing Effectiveness of Selected Machine Learning Algorithm:**
   - Evaluating the efficacy of a supervised machine learning algorithm, specifically Random Forest Regression, in capturing spatio-temporal relationships.
   - Investigating the seasonal variations in the performance of region-specific trained Random Forest Regression models.
...
![](assets/IMG/REC_Curves_BothSeasons.png)
